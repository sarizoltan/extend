...
wp_register_style( 'rpwe-style', get_template_directory_uri() . '/css/rpwe-admin.css', array(), RPWE_VERSION );
}
...
wp_register_style( 'rpwe-style', get_template_directory_uri() . '/css/rpwe-frontend.css', array(), RPWE_VERSION );
}
